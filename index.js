...
const Fahrenheittocelcius=(tempinfahrenheit)=>{ return tempinfahrenheit.map((tempinfahrenheit0)=>(tempinfahrenheit0-32) *5/9)}

const celsiustofahrenheit=(tempincelsius)=>{return tempincelsius.map((tempincelcius1)=>(tempincelcius1 * 9/5)+32)}

const AllTempinC= tempincelsius.concat(Fahrenheittocelcius(tempinfahrenheit))
const AllTempinF= tempinfahrenheit.concat(celsiustofahrenheit(tempincelsius))

let tot_temperature_in_celsius = 0
AllTempinC.forEach(AllTempinC => tot_temperature_in_celsius += AllTempinC)

let tot_temperature_in_fahrenheit= 0
AllTempinF.forEach(AllTempinF => tot_temperature_in_fahrenheit += AllTempinF)

console.log (tot_temperature_in_celsius, tot_temperature_in_fahrenheit)
